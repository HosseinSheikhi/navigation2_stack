...
set(_exported_dependencies "rclcpp;std_msgs;geometry_msgs;nav_2d_msgs;dwb_msgs;nav2_costmap_2d;pluginlib;sensor_msgs;visualization_msgs;nav_2d_utils;nav_msgs;tf2_ros;nav2_util;nav2_core")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(dwb_core_INCLUDE_DIRS "${_include_dirs}")
          endif()

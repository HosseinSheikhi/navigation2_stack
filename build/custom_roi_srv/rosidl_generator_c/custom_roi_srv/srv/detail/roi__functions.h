...
#ifndef CUSTOM_ROI_SRV__SRV__DETAIL__ROI__FUNCTIONS_H_
#define CUSTOM_ROI_SRV__SRV__DETAIL__ROI__FUNCTIONS_H_
...
#include "custom_roi_srv/msg/rosidl_generator_c__visibility_control.h"

#include "custom_roi_srv/srv/detail/roi__struct.h"

/// Initialize srv/ROI message.
/**
...
/// Create srv/ROI message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_roi_srv__srv__ROI_Request__init().
...
/// Destroy srv/ROI message.
/**
 * It calls
 * custom_roi_srv__srv__ROI_Request__fini()
...
/// Initialize array of srv/ROI messages.
/**
...
/// Finalize array of srv/ROI messages.
/**
 * It calls
 * custom_roi_srv__srv__ROI_Request__fini()
...
/// Create array of srv/ROI messages.
/**
 * It allocates the memory for the array and calls
 * custom_roi_srv__srv__ROI_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ROI messages.
/**
 * It calls
 * custom_roi_srv__srv__ROI_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_roi_srv__srv__ROI_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_roi_srv
...
/**
 * It calls
 * custom_roi_srv__srv__ROI_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_roi_srv
...
/**
 * It allocates the memory for the array and calls
 * custom_roi_srv__srv__ROI_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_roi_srv
...
/**
 * It calls
 * custom_roi_srv__srv__ROI_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_ROI_SRV__SRV__DETAIL__ROI__FUNCTIONS_H_
